---
title: "[AI] 스프린트 미션 16 - [AI] 스프린트 미션 16 | 코드잇"
source: "https://www.codeit.kr/topics/sp-ai-mission-16/lessons/14112"
author:
published:
created: 2026-03-09
...
여러분들은 지금까지 AI 스프린트 미션들을 수행하며 다양한 모델들을 학습 및 구현해보셨습니다. 이번 미션에서는 그 모델들을 다시 가져와서, 여러 형태의 포맷으로 모델을 변환하여 저장해보는 실습을 해봅시다.
...
- [mnist\_cnn.onnx](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=14112&version=1&directory=/mnist_cnn.onnx&name=mnist_cnn.onnx)
	- 해당 데이터는 실습 시간에서 직접 추출한 데이터와 동일해요. 따라서, 실습 시간에 추출했던 데이터를 그대로 사용해도 무방합니다.
- [mission16\_target\_images.zip](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=14112&version=1&directory=/mission16_target_images.zip&name=mission16_target_images.zip)
